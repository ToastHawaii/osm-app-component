...
export declare function createOverPassLayer<M>(group: string, value: string, icon: string, query: string, attributes: Attribute<M>[], local: any, color: string, isActive: () => boolean): any;
